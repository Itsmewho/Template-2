    ...
    <>
      <section>
        <div className="page-wrapper">
          ...
          {/* --- grid part 2 --> */}
          <div className="articles-grid margin-bottom">
            <div className="fitness-cat">
              <div className="eyebrow">
                <span>Recipes</span>
              </div>
              ...
              <div className="article-btn">
                <Link
                  ...
                  className="l-btn link"
                  onClick={scrollToTop}>
                  <span className="l-btn-text" data-hover="Recipes">
                    Read more
                  </span>
                </Link>
              </div>
            ...
            <div className="lifestyle-cat">
              ...
              <div className="article-btn">
                <Link
                  ...
                  className="l-btn link"
                  onClick={scrollToTop}>
                  <span className="l-btn-text" data-hover="Muscle">
                    Read more
                  </span>
                </Link>
              </div>
            ...
            <div className="nutrition-cat">
              ...
              <div className="article-btn">
                <Link
                  ...
                  className="l-btn link"
                  onClick={scrollToTop}>
                  <span className="l-btn-text" data-hover="Research">
                    Read more
                  </span>
                </Link>
              </div>
