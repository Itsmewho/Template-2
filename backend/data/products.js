...
const products = [
  {
    ...
    description:
      'dummy text = A specialized protein blend tailored to support weight gain and muscle mass development. Formulated with high-quality ingredients, it fuels intense workouts and promotes healthy weight gain for aspiring bodybuilders.',
    ingredients: 'dummy text',
    brand: 'Thunder',
    category: 'Amino',
    price: 16789.99,
    countInStock: 10,
